...
```sh
git clone https://github.com/Pepe-Marquez/nomad-polymerization-reactions.git
cd nomad-polymerization-reactions
...
nomad-polymerization-reactions==x.y.z
```
...
```sh
pip install dist/nomad-polymerization-reactions-0.1.0
```
